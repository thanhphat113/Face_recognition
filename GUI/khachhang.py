...
class Ui_Form(object):
    ...
    "")
                ...
                self.btnThem.setMinimumSize(100,30)
    ...
    "")
                ...
                self.btnXoa.setMinimumSize(100,30)
                ...
                self.btnSua.setMinimumSize(100,30)
                icon2 = QtGui.QIcon()
                ...
                self.comboBox.addItem("Mã khách hàng")
                self.comboBox.addItem("Giới tính")
                self.comboBox.addItem("Tên khách hàng")
