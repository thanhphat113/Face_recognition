...
"border:1px solid black;")
        ...
        self.txtColor.setGeometry(QtCore.QRect(170, 130, 181, 21))
        self.txtColor.setObjectName("txtColor")
        self.txtWeight = QtWidgets.QLineEdit(Dialog)
        self.txtWeight.setGeometry(QtCore.QRect(170, 170, 181, 21))
